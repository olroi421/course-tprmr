...
|----------|------|---------------|
| Аналіз предметної області | 1 | Правильність визначення ресурсів, атрибутів та типів |
| Кінцеві точки API | 2 | Правильні HTTP методи, URI, статус-коди, обґрунтування |
| Структури даних | 2 | Коректні JSON, різні DTO, реалістичні дані |
| Обробка помилок | 1 | Стандартна структура, коди помилок, приклади |
| Відповіді та обґрунтування | 1 | Розуміння REST принципів, якість пояснень |
