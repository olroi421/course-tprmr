...
### Крок 9. Створення документації README

Створіть файл README.md з описом проєкту та інструкціями по використанню.
...
3. Активуйте його: `venv\Scripts\activate` (Windows) або `source venv/bin/activate` (Linux/Mac)
...
- `GET /tasks/stats/summary` - Отримати статистику
```
...
Зробіть скріншоти Swagger UI з результатами тестування всіх ендпоінтів. Скріншоти мають показувати успішні запити та відповіді для кожної операції CRUD.

Створіть звіт у форматі Markdown з описом виконаної роботи, структурою проєкту та поясненнями ключових рішень.
...
### 4 бали - CRUD + Розширений функціонал
...
| 2 | 3-4 CRUD ендпоінти працюють |
| 3 | Всі 5 CRUD ендпоінтів працюють |
| 4 | CRUD + валідація + фільтрація + документація |
| 5 | Все + додатковий функціонал + README + GitHub + скріншоти |
